  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        // '@ghost-web/models': path.resolve(__dirname, '../../packages/ghost-web-models/src'),
        // '@ghost-web/api': path.resolve(__dirname, '../../packages/ghost-web-api/src'),
        // '@ghost-web/components': path.resolve(__dirname, '../../packages/ghost-web-components/src'),
        // '@ghost-web/react-hooks': path.resolve(__dirname, '../../packages/ghost-web-react-hooks/src'),
